        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-secondary p-0 navbar-dark toggled">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{route('transaccionesAdmin')}}"><i class="fas fa-donate"></i><span>Transacciones</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="{{route('contratosAdmin')}}"><i class="fas fa-book"></i><span>Contratos</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="{{route('incidenciasAdmin')}}"><i class="fas fa-exclamation-triangle"></i><span>Incidencias</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="{{route('eventosAdmin')}}"><i class="fas fa-calendar-alt"></i><span>Eventos</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="{{route('visitantesAdmin')}}"><i class="fas fa-walking"></i><span>Visitantes</span></a></li>
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in"><a class="dropdown-item" href="{{route('dashboard')}}"><i class="fas fa-tachometer-alt fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Dashboard</a><a class="dropdown-item" href="{{route('residentesAdmin')}}"><i class="fas fa-users fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Residentes</a><a class="dropdown-item" href="{{route('transaccionesAdmin')}}"><i class="fas fa-donate fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Transacciones</a><a class="dropdown-item" href="{{route('contratosAdmin')}}"><i class="fas fa-book fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Contratos</a><a class="dropdown-item" href="{{route('incidenciasAdmin')}}"><i class="fas fa-exclamation-triangle fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Incidencias</a><a class="dropdown-item" href="{{route('eventosAdmin')}}"><i class="fas fa-calendar-alt fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Eventos</a><a class="dropdown-item" href="{{route('visitantesAdmin')}}"><i class="fas fa-walking fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Visitantes</a>
