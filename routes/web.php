...
//Route::get('/updateResidents/{id}/edit', [residentscontroller::class, 'updateResidents'])->name('updateResidents');
Route::delete('/residentes/eliminar/{residentId}', [residentscontroller::class, 'deleteResident'])->name('resident.delete');
